...
TEST_F(ItemTest, createJson_noAssignedTask)
{
  ...
  std::string expected(
    R"({"indexType":"Item","itemId":1,"itemName":"Test Item","itemStatus":"New","itemStatusCode":1,"projectId":10,"sprintId":12,"storyPoint":3,"timestamp":"2024-02-28T12:34:56.123","totalEstimatedTime":5.5})");
