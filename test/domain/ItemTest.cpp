...
namespace measurementor
{
    ...
    TEST_F(ItemTest, createJson_noAssignedTask)
    {
        ...
        std::string expected(R"({"itemId":1,"itemName":"Test Item","projectId":10,"sprintId":12,"status":"New","statusCode":1,"storyPoint":3,"timestamp":"2024-02-28T12:34:56.123","totalEstimatedTime":5.5})");
