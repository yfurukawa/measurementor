...
{
    EXPECT_EQ(1708312332, ToTimePoint("20240219T121212Z") );
}

TEST(FromISO8601StringTest, BasicString_JST)
{
    EXPECT_EQ(1708279932, ToTimePoint("20240219T121212+0900") );
}

TEST(FromISO8601StringTest, BasicString_Other)
{
    EXPECT_EQ(1708344732, ToTimePoint("20240219T121212-0900") );
}

TEST(FromISO8601StringTest, BasicString_microsec)
{
    EXPECT_EQ(1708279933, ToTimePoint("20240219T121212.123456+0900") );
}

TEST(FromISO8601StringTest, ExtendedString_GMT)
{
    EXPECT_EQ(1708312332, ToTimePoint("2024-02-19T12:12:12Z") );
}

TEST(FromISO8601StringTest, ExtendedString_JST)
{
    EXPECT_EQ(1708279932, ToTimePoint("2024-02-19T12:12:12+09:00") );
}

TEST(FromISO8601StringTest, ExtendedString_Other)
{
    EXPECT_EQ(1708344732, ToTimePoint("2024-02-19T12:12:12-09:00") );
}

TEST(FromISO8601StringTest, ExtendedString_microsec)
{
    EXPECT_EQ(1708279933, ToTimePoint("2024-02-19T12:12:12.543211+09:00") );
}
